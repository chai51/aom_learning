...
const Default_Mv_Class0_Hp_Cdf = [160 * 128, 32768, 0];
const Default_Mv_Hp_Cdf = [128 * 128, 32768, 0];
const Default_Mv_Sign_Cdf = [128 * 128, 32768, 0];
...
const Default_Mv_Class0_Bit_Cdf = [216 * 128, 32768, 0];
...
const Default_Mv_Joint_Cdf = [4096, 11264, 19328, 32768, 0];
...
const Default_Delta_Q_Cdf = [28160, 32120, 32677, 32768, 0];
const Default_Delta_Lf_Cdf = [28160, 32120, 32677, 32768, 0];
...
const Default_Inter_Tx_Type_Set2_Cdf = [770, 2421, 5225, 12907, 15819, 18927, 21561, 24089, 26595, 28526, 30529, 32768, 0];
...
const Default_Cfl_Sign_Cdf = [1418, 2123, 13340, 18405, 26972, 28343, 32294, 32768, 0];
...
const Default_Use_Wiener_Cdf = [11570, 32768, 0];
const Default_Use_Sgrproj_Cdf = [16855, 32768, 0];
const Default_Restoration_Type_Cdf = [9413, 22581, 32768, 0];
